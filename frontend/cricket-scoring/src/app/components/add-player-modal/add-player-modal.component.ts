          ...
          <div class="modal-body">
            <div class="player-form">
              ...
              <div class="form-group">
                ...
                <select id="playerRole" [(ngModel)]="playerRole" class="form-control">
              ...
              <div class="form-group">
                <label for="jerseyNumber">Jersey Number (Optional)</label>
                <input
                  id="jerseyNumber"
                  type="number"
                  [(ngModel)]="jerseyNumber"
              ...
              <button class="btn-add" (click)="addPlayer()">
                Add Player
              </button>
            </div>

            <div class="players-list">
              <h3>Added Players ({{ players().length }}/11)</h3>
              @if (players().length === 0) {
                ...
                <div class="player-items">
                  @for (player of players(); track $index) {
                    <div class="player-item">
                      ...
                      <button class="remove-btn" (click)="removePlayer($index)">
                        Remove
                      </button>
                    </div>
                  }
...
export class AddPlayerModalComponent {
  ...
  addPlayer(): void {
    if (this.playerName.trim()) {
      ...
      const player: Player = {
        ...
        bowlingHand: this.bowlingHand,
        isWicketKeeper: this.isWicketKeeper || this.playerRole === 'Wicket-Keeper'
      };
  ...
  savePlayers(): void {
    if (this.players().length > 0) {
      this.playersAdded.emit(this.players());
      this.close();
    }
  }
